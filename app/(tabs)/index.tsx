...
import { Package, AlertTriangle, ShoppingCart, Calendar, TrendingUp, MapPin } from 'lucide-react-native';
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.eventContent}>
                  ...
                  <View style={styles.eventDetails}>
                    <View style={styles.eventDetail}>
                      <Calendar size={14} color={Colors.neutral.gray} style={styles.eventDetailIcon} />
                      <Text style={styles.eventDetailText}>{formatDate(event.date)}</Text>
                    </View>
                    <View style={styles.eventDetail}>
                      <MapPin size={14} color={Colors.neutral.gray} style={styles.eventDetailIcon} />
        ...
        <View style={styles.quickActionsContainer}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              <View style={[styles.quickActionIcon, { backgroundColor: Colors.primary.burgundyLight }]}>
            ...
            >
              <View style={[styles.quickActionIcon, { backgroundColor: Colors.status.info }]}>
            ...
            >
              <View style={[styles.quickActionIcon, { backgroundColor: Colors.status.success }]}>
