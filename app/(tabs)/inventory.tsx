...
export default function InventoryScreen() {
  ...
  const handleScanBarcode = () => {
    ...
    // In a real app, you would navigate to a barcode scanner screen
    // or use a barcode scanning library
    Alert.alert("Scan Barcode", "Would you like to scan a product barcode?", [
      {
        text: "Cancel",
        style: "cancel",
      },
      {
        text: "Scan",
        onPress: () => {
          // Mock successful scan for demo purposes
          setTimeout(() => {
            Alert.alert(
              "Barcode Scanned",
              "Product found: Coffee Beans - Dark Roast",
              [
                {
                  text: "View Product",
                  onPress: () => {
  ...
  const handleViewTotalProducts = () => {
    router.push("/total-products" as any);
  };
