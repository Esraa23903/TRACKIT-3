...
import { Calendar, MapPin, Clock, Check, X, Ticket, User, DollarSign } from 'lucide-react-native';
...
export default function EventsScreen() {
  ...
  const eventRequests = [
    ...
    },
    {
      ...
      description: 'Learn how to leverage digital marketing to grow your small business.',
      status: 'pending'
    },
    {
      id: 'er5',
      ...
      description: 'Discover strategies for creating sustainable supply chains and reducing environmental impact.',
      status: 'pending'
    }
  ];
  ...
  const additionalEvents = [
    {
      ...
      description: 'Join industry leaders to explore the latest innovations in supply chain management. This full-day summit features keynote speakers, panel discussions, and networking opportunities.',
    ...
    },
    {
      ...
      description: 'Learn about financing options available for small businesses in Egypt. This workshop covers loans, grants, venture capital, and alternative funding sources.',
    ...
    },
    {
      ...
      description: 'Discover how digital inventory management systems can streamline your operations and reduce costs. Includes live demonstrations of popular software solutions.',
      image: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2053&auto=format&fit=crop',
      price: 79.99,
      category: 'Technology',
      attendees: 120,
      isRegistered: false
    },
    {
      ...
      description: 'Stay updated on the latest international trade regulations affecting Egyptian businesses. This seminar covers tariffs, customs procedures, and compliance requirements.',
        ...
        [
          ...
          },
          {
            ...
            onPress: () => {
              ...
              router.push(`/event-details?id=${event.id}&register=true`);
            }
          }
        ]
      );
      ...
      <View style={styles.eventContent}>
        ...
        <View style={styles.eventFooter}>
          <Text style={styles.eventPrice}>
            {(item.price === 0 || item.price === undefined) ? 'Free' : `$${item.price.toFixed(2)}`}
          </Text>
          <TouchableOpacity 
            style={[
              styles.eventButton,
    ...
    >
      <View style={styles.ticketHeader}>
        ...
        <View style={styles.ticketHeaderContent}>
          ...
          <Text style={styles.ticketPurchaseDate}>Purchased: {formatDate(item.purchaseDate)}</Text>
        </View>
      </View>
      ...
      <View style={styles.ticketDetails}>
        <View style={styles.ticketDetailItem}>
          <User size={16} color={Colors.neutral.gray} style={styles.ticketDetailIcon} />
          <Text style={styles.ticketDetailLabel}>Attendee:</Text>
          <Text style={styles.ticketDetailText} numberOfLines={1}>{item.attendeeName}</Text>
        </View>
        
        <View style={styles.ticketDetailItem}>
          <Calendar size={16} color={Colors.neutral.gray} style={styles.ticketDetailIcon} />
          <Text style={styles.ticketDetailLabel}>Event Date:</Text>
          <Text style={styles.ticketDetailText}>{formatDate(item.eventDate)}</Text>
        </View>
        
        <View style={styles.ticketDetailItem}>
          <DollarSign size={16} color={Colors.neutral.gray} style={styles.ticketDetailIcon} />
