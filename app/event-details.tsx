...
import { Calendar, Clock, MapPin, Users, User, ArrowLeft, Share2, Heart } from 'lucide-react-native';
...
export default function EventDetailsScreen() {
  ...
  const handleShare = () => {
    Alert.alert(
      "Share Event",
      "Share this event with your contacts",
      [{ text: "OK" }]
    );
  };
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.infoSection}>
            <View style={styles.infoItem}>
              <Calendar size={20} color={Colors.neutral.gray} style={styles.infoIcon} />
              <Text style={styles.infoText}>{formatDate(event.date)}</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Clock size={20} color={Colors.neutral.gray} style={styles.infoIcon} />
              <Text style={styles.infoText}>{event.time}</Text>
            </View>
            
            <View style={styles.infoItem}>
              <MapPin size={20} color={Colors.neutral.gray} style={styles.infoIcon} />
              <Text style={styles.infoText}>{event.location}</Text>
            </View>
            
            <View style={styles.infoItem}>
              <User size={20} color={Colors.neutral.gray} style={styles.infoIcon} />
              <Text style={styles.infoText}>Organized by {event.organizer}</Text>
            </View>
            
            {event.attendees && (
              <View style={styles.infoItem}>
                <Users size={20} color={Colors.neutral.gray} style={styles.infoIcon} />
          ...
          <View style={styles.priceSection}>
            ...
            <Text style={styles.price}>
              {(event.price === 0 || event.price === undefined) ? 'Free' : `$${event.price.toFixed(2)}`}
            </Text>
          </View>
        </View>
      </ScrollView>
