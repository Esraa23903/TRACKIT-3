          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View>
                ...
                <Text style={styles.settingDescription}>
                  Notifications about shipment status changes
                </Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View>
                ...
                <Text style={styles.settingDescription}>
                  Notifications about low stock and inventory issues
                </Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <View>
                ...
                <Text style={styles.settingDescription}>
                  Notifications about upcoming events and reminders
                </Text>
              </View>
            </View>
            <Switch
