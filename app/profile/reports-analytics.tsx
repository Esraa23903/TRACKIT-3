        ...
        <View style={styles.timeRangeContainer}>
          <TouchableOpacity
            style={[
              ...
              timeRange === "1m" && styles.activeTimeRange,
            ]}
          ...
          >
            <Text
              style={[
                ...
                timeRange === "1m" && styles.activeTimeRangeText,
              ]}
            >
              1M
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeRangeButton,
              timeRange === "3m" && styles.activeTimeRange,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeRangeText,
                timeRange === "3m" && styles.activeTimeRangeText,
              ]}
            >
              3M
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeRangeButton,
              timeRange === "6m" && styles.activeTimeRange,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeRangeText,
                timeRange === "6m" && styles.activeTimeRangeText,
              ]}
            >
              6M
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeRangeButton,
              timeRange === "1y" && styles.activeTimeRange,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeRangeText,
                timeRange === "1y" && styles.activeTimeRangeText,
              ]}
            >
              1Y
            </Text>
